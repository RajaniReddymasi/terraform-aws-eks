...
# # EKS cluster can be accessed from bastion host, api server is hosted on 443
...
# # EKS control plane accepting all traffic from nodes, if you wont give this your cluser will not connect for nodes
